...
export const insuranceEvaluationV2Rules = {
  "metadata": {
    ...
    "approvedWeightingDirection": {
      ...
      "consideredButNotMainEmphasisSteps": [
        "costApproach"
      ],
  ...
  "signals": {
    ...
    "high_long_term_hospitalization_limit": {
      ...
      "evidenceRequirements": [
        "annual/lifetime limit amount",
        "unlimited cover statement",
        "approved high-limit band",
        "ICU/long-stay evidence"
      ],
      "scoringBand": "hard_priority_overlap_capped",
      "missingEvidenceBehavior": "penalty_and_advisor_confirmation",
    ...
    "international_coverage": {
      ...
      "evidenceRequirements": [
        "territory scope",
        "Europe/worldwide wording",
        "emergency abroad",
        "planned treatment abroad",
        "reimbursement abroad terms"
      ],
  ...
  "categoryPolicy": {
    "bestMatch": {
      ...
      "requiredEvidenceCertainty": [
        "acceptable eligibility certainty",
        "meaningful Step 5 fit",
        "no unresolved hard-priority conflict"
      ],
      "mustNotMean": [
        "objectively best",
        "cheapest",
    ...
    "premiumChoice": {
      ...
      "requiredEvidenceCertainty": [
        "breadth evidence",
        "network/limit/benefit evidence",
        "minimum certainty threshold"
      ],
      "mustNotMean": [
        "highest price",
        "guaranteed superior cover",
        "luxury"
      ]
    },
    "smartBudgetChoice": {
      ...
      "requiredEvidenceCertainty": [
        "acceptable hard-priority fit",
        "deductible/cost trade-off evidence",
        "coherent narrower coverage"
      ],
      "mustNotMean": [
        "cheapest",
        "low quality",
        "sufficient for every stated need"
      ]
    },
  ...
  "existingPolicyPolicy": {
    "mayAffectRanking": [
      "reliable confirmed gaps aligned with proposed-product evidence",
      "continuity risks supported by product evidence"
    ],
    "mustNotAffectRanking": [
      "unknown current policy terms",
      "PDF absence",
      "current policy facts as proposed-product evidence"
    ],
    "advisorConfirmationRules": [
      "waiting-period continuity",
      "pre-existing condition handling",
      "duplicate cover",
      "current policy advantages worth preserving"
    ],
  ...
  "explanationPolicy": {
    ...
    "customerWordingBoundaries": [
      "supports",
      "appears aligned",
      "needs confirmation",
      "avoid covered/excluded/unlimited/no waiting period/no participation without exact evidence"
    ],
