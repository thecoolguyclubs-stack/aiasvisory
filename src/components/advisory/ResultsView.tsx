...
export function ResultsView() {
  ...
  return (
    <AdvisoryShell wide>
      <PageHeading
        description="Τρεις διαφορετικές κατευθύνσεις, ταξινομημένες με βάση όσα δήλωσες στο assessment."
        eyebrow="ΠΡΟΣΩΠΟΠΟΙΗΜΕΝΗ ΑΞΙΟΛΟΓΗΣΗ"
        title="Οι 3 προτάσεις που ταιριάζουν στο προφίλ σου"
      />
      ...
      <aside className={styles.resultsDisclaimer}>
        ...
        <p>
          ...
          από ασφαλιστικό σύμβουλο. Το ποσό δημιουργείται αποκλειστικά για
          σκοπούς επίδειξης και δεν αποτελεί τιμή, προσφορά ή προεκτίμηση
